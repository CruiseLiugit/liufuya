...
public class Constants {
	...
	public static final String[] CRM_MENUS_TREE1 = { "会员资料", "扩展资料", "会员等级",
			"会员活动", "会员黑名单", "会员诉求", "诉求类别", "短信发送" };
	// 积分管理
	public static final String[] CRM_MENUS_TREE2 = { "兑换奖品资料管理", "消费积分规则管理",
			"兑奖规则信息管理", "会员积分兑换管理", "会员积分调整", "会员积分清除", "会员积分补录" };

	public static final Object[][] CRM_MENUS_TREE = new Object[][] {
			new Object[] { "会员管理", "会员资料", "扩展资料", "会员等级", "会员活动", "会员黑名单",
					"会员诉求", "诉求类别", "短信发送" },
			new Object[] { "积分管理", "兑换奖品资料管理", "消费积分规则管理", "兑奖规则信息管理",
	 ...
	 */
	public static final Object[] MEMEBER_COL_ORDER = new String[] { "loginname",
		"realname", "usersex", "usertype", "city", "cardid","cardscore","cardbalance",
		"createdate" };
	/**
	 * "表头列名" captions for properties in same order as in NATURAL_COL_ORDER.
	 */
	public static final String[] MEMEBER_COL_HEADERS_CHINESE = new String[] { "手机号码",
		"名称", "性别", "类型","城市","实体卡号","积分","余额","注册日期" };
	
	//会员表单中的固定下拉菜单的值
	public static final String[] MEMBER_AGE_AREAS = new String[]{"60前","60后","70后","80后","90后","00后","10后"};  //年龄段
	public static final String[] MEMBER_WORK_TYPES = new String[]{"科研人员","律师/法务/合规","教师","医院/医疗/护理","公务员","在校学生","翻译","建筑","行政/后勤","互联网/电子商务/网游","销售人员","采购","公关/媒介","酒店/旅游","计算机软件","物流/仓储","人力资源","艺术/设计","其他"};  //工作类型
	public static final String[] MEMBER_FAMILY_MONEY = new String[]{"1000以下","1000-3000","3000-5000","10000-20000","20000-50000","50000以上"};  //家庭收入
	public static final String[] MEMBER_ENTITY_CARD_STATUS = new String[]{"已开卡","已使用","已作废"};  //实体卡状态
	public static final String[] MEMBER_REG_TYPES = new String[]{"实体卡注册","网站注册","微信注册","后台注册"};  //会员注册类型
