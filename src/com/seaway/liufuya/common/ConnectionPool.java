 ...
 * 虽然现在用APACHE COMMONS DBCP可以非常方便的建立数据库连接池， // 但是像这篇文章把数据库连接池的内部原理写的这么透彻，
 * 
 * @author lililiu
 * 
 */
public class ConnectionPool {
	...
	private String dbUrl = "jdbc:mysql://localhost:3306/shopdb?useUnicode=true&characterEncoding=utf-8"; // 数据
																											// URL
	private String dbUsername = "root"; // 数据库用户名
	private String dbPassword = "rootroot"; // 数据库用户密码
	...
	// 用饿汉式，私有对象属性，并实例化
	private static ConnectionPool connectPool = new ConnectionPool();
